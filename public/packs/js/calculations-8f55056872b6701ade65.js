...
function totVetements() {
  ...
  var sum = numberChemiseCoton + numberChemiseViscose + numberTshirtCoton + numberTshirtPoly + numberPolair + numberPullAcry + numberPulllaine + numberSweat + numberPolo + numberRobeC + numberRobePoly + numberChaussureTissu;
...
var defaultVetement = (Number(defaultChemiseCoton) + Number(defaultChemiseviscose) + Number(defaultTshirtCoton) + Number(defaultTshirtPoly) + Number(defaultPolair) + Number(defaultAcrylique) + Number(defaultpullenlaine) + Number(defaultsweat) + Number(defaultpolo) + Number(defaultRobeCoton) + Number(defaultRobePoly) + Number(defaultChaussureTissu)).toFixed(2);
...
/******/ });
//# sourceMappingURL=calculations-8f55056872b6701ade65.js.map