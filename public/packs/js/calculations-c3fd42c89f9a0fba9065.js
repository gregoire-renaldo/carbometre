...
function field(userField, scoreCarbon, scoreField) {
  console.log('infield');
  var userValue = document.getElementById(userField);
  var carbonMultiplier = document.getElementById(scoreCarbon);
  var scoreValue = scoreField;
  var defaultValue = (userValue.value * carbonMultiplier).toFixed(2);
  scoreValue.innerHTML = defaultValue;
  userValue.addEventListener("input", multiplyField);

  function multiplyField() {
    console.log('hello');
    var one = parseFloat(userValue.value) || 0;
    var ccfield = parseFloat(one * carbonMultiplier).toFixed(2);
    scoreValue.innerHTML = ccfield; // functionTotToPass()
  }
}

field('userEssence', 2.8, 'scoreEssence', totVoiture)(); // field essence
...
/******/ });
//# sourceMappingURL=calculations-c3fd42c89f9a0fba9065.js.map