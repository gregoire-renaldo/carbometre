...
function totVetements() {
  ...
  var sum = numberChemiseCoton + numberChemiseViscose + numberTshirtCoton + numberTshirtPoly + numberPolair + numberPullAcry + numberPulllaine + numberSweat;
...
var defaultVetement = (Number(defaultChemiseCoton) + Number(defaultChemiseviscose) + Number(defaultTshirtCoton) + Number(defaultTshirtPoly) + Number(defaultPolair) + Number(defaultAcrylique) + Number(defaultpullenlaine) + Number(defaultsweat)).toFixed(2);
...
/******/ });
//# sourceMappingURL=calculations-608945a6df35c979e3d2.js.map