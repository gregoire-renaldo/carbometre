...
function totVetements() {
  ...
  var sum = numberChemiseCoton + numberChemiseViscose + numberTshirtCoton + numberTshirtPoly + numberPolair + numberPullAcry + numberPulllaine + numberSweat + numberPolo + numberRobeC + numberRobePoly + numberChaussureTissu + numberSport;
...
var defaultVetement = (Number(defaultChemiseCoton) + Number(defaultChemiseviscose) + Number(defaultTshirtCoton) + Number(defaultTshirtPoly) + Number(defaultPolair) + Number(defaultAcrylique) + Number(defaultpullenlaine) + Number(defaultsweat) + Number(defaultpolo) + Number(defaultRobeCoton) + Number(defaultRobePoly) + Number(defaultChaussureTissu) + Number(defaultChaussureSport)).toFixed(2);
...
/******/ });
//# sourceMappingURL=calculations-b12b2f9973d52735e461.js.map