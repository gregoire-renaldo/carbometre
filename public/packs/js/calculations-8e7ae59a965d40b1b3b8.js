...
function totVetements() {
  ...
  var sum = numberChemiseCoton + numberChemiseViscose + numberTshirtCoton + numberTshirtPoly + numberPolair + numberPullAcry + numberPulllaine + numberSweat + numberPolo + numberRobeC + numberRobePoly;
...
var defaultVetement = (Number(defaultChemiseCoton) + Number(defaultChemiseviscose) + Number(defaultTshirtCoton) + Number(defaultTshirtPoly) + Number(defaultPolair) + Number(defaultAcrylique) + Number(defaultpullenlaine) + Number(defaultsweat) + Number(defaultpolo) + Number(defaultRobeCoton) + Number(defaultRobePoly)).toFixed(2);
...
/******/ });
//# sourceMappingURL=calculations-8e7ae59a965d40b1b3b8.js.map