...
function totVetements() {
  ...
  var sum = numberChemiseCoton + numberChemiseViscose + numberTshirtCoton + numberTshirtPoly + numberPolair + numberPullAcry + numberPulllaine + numberSweat + numberPolo + numberRobeC + numberRobePoly + numberChaussureTissu + numberSport + numberAnorak;
...
var defaultVetement = (Number(defaultChemiseCoton) + Number(defaultChemiseviscose) + Number(defaultTshirtCoton) + Number(defaultTshirtPoly) + Number(defaultPolair) + Number(defaultAcrylique) + Number(defaultpullenlaine) + Number(defaultsweat) + Number(defaultpolo) + Number(defaultRobeCoton) + Number(defaultRobePoly) + Number(defaultChaussureTissu) + Number(defaultChaussureSport) + Number(defaultAnorak)).toFixed(2);
...
function totAutre() {
  ...
  var sum = numberAspirateur + numberCongelateur + numberRefrigerateur + numberFourelec + numberLavelinge + numberMicroonde + numberSmartphone + numberOrdinateur + numberAutofr + numberVelo + numberVeloelec + numberAutofrelec + numberJeanmonde + numberJeanfr + numberAppartementneuf + numberAutoasie + numberAutoasieelec + numberVoitElecMoins + numberVoitElecPlus + numberTroti;
...
/******/ });
//# sourceMappingURL=calculations-40735f68691c8cf2875e.js.map