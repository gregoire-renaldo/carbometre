...
function total() {
  ...
  var sumTotal = numberVoiture + numberAlim + numberTransport + numberEnergie + numberAutre + numberValeur;
...
function totVoiture() {
  ...
  var sumVoiture = numberEssence + numberGazole + numberGpl + numberE85 + numberElectrique + numberEssencel + numberGazolel + numberLgpl + numberLe85 + numberLelectrique;
...
var userGaz = document.getElementById('userGaz');
var gazcc = 3.35;
var scoreGaz = document.getElementById('scoreGaz');
var defaultGaz = (userGaz.value * gazcc).toFixed(2);
scoreGaz.innerHTML = defaultGaz;
userGaz.addEventListener("input", multiplyGaznat);
...
var defaultVoiture = (Number(defaultEssence) + Number(defaultGazole) + Number(defaultGPL) + Number(defaultE85) + Number(defaultElectrique) + Number(defaultEssencel) + Number(defaultGazolel) + Number(defaultLgpl) + Number(defaultLe85) + Number(defaultLelectrique)).toFixed(2);
...
function totEnergie() {
  ...
  var sumEnergie = numberElectricite + numberGazkwh + numberGazm + numberFioul + numberGranulebois + numberBuchebois + numberEau + numberStreaming + numberTweet + numberMail;
...
function totAlim() {
  ...
  var sum = numberble + numbercarotte + numberriz + numberPomedeterre + numberSaladesaison + numberSaladeSs + numberTomates + numberTomatesFrss + numberVeau + numberBoeuf + numberLaitvache + numberPoulet + numberOeufs;
...
totalAlimBox.innerHTML = defaultAlim; // category autre
...
/******/ });
//# sourceMappingURL=calculations-db83d32cf740b9f92187.js.map