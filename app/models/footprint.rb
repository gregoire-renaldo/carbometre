class Footprint < ApplicationRecord
  ...
  def total_autres
    ((self.mail*0.035) + (self.tweet*0.00002) + (self.aspirateur*52) + (self.congelateur*415) + (self.refrigerateur250l*300) + (self.fourelectrique*217) + (self.lavelinge*305) + (self.microonde*100) + (self.smartphone*15) + (self.ordinateur*150) + (self.streaming*25)).ceil(2)
  end
