class Footprint < ApplicationRecord
  ...
  def total_autres
    ( (self.voitureelec*8) + (self.voiture*6) + (self.velo*150) + (self.veloelec*500) + (self.aspirateur*52) + (self.congelateur*415) + (self.refrigerateur250l*300) + (self.fourelectrique*217) + (self.lavelinge*305) + (self.microonde*100) + (self.smartphone*15) + (self.ordinateur*150)).ceil(2)
  end
